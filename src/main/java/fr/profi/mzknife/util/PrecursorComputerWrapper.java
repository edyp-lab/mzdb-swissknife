...
public class PrecursorComputerWrapper implements IPrecursorComputation {
  ...
  private String[] annotations = {"source", "mgf.id", "scan.number", "scan.selector", "in.sw", "precursor.intensity.sw", "prediction", "prediction.pattern.score", "rank",  "filtered.peaks.count.sw", "precursor.signal.total.sw", "precursor.signal.max.sw", "precursor.rank.sw" };
